...
function addEventListenerForAlphabet() {
    document.querySelectorAll('button.char-button').forEach(charBtn => charBtn.addEventListener("click", handleAlphabetClick, {once: true}));
}
...
function gameOverAnnouce(message) {
    ...
    messageDisplay.innerText = `The word is ${guessWord}\n${message.toUpperCase()}`;
}
...
const guessWords = [
                    ...
                    new HangManWord('countries', 'australia', 'Country had famous kanguru'),
                ];
